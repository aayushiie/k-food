...
export async function createProduct(req, res) {
  try {
    ...
    const imageUrls = uploadResults.map((result) => result.secure_url); // image secure url generated and save to db
...
export async function getAllOrders(_, res) {
  try {
    // populate(colName): gets the referential data from the referenced table
